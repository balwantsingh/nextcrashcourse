    ...
    return (
        ...
        <meta name='keywords' content='web development, programming' />
            ...
            <form className="block" onSubmit={formik.handleSubmit}>
                ...
                <label className="text-sm font-bold mb-2 block mt-5" htmlFor="password">Password</label>
                <input
                className="border border-gray-300 shadow px-5 py-2 block"
                onChange={formik.handleChange}
                type='password'
                ...
                <label className="text-sm font-bold mb-2 block mt-5" htmlFor="repassword">Password again</label>
                <input
                className="border border-gray-300 shadow px-5 py-2 block"
                onChange={formik.handleChange}
                type='password'
                ...
                {formik.touched.repassword &&formik.errors.repassword ? <div className='text-red-600 text-xs'>{formik.errors.repassword}</div>: null}

                <button className="mt-5 w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-blue-600 font-medium" type="submit block">Register</button>
            </form>
        </div>
    )
}
