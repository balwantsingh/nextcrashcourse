    ...
    return (
        ...
        <meta name='keywords' content='web development, programming' />
            ...
            <form className="block" onSubmit={formik.handleSubmit}>
                ...
                <label className="text-sm font-bold block mt-5" htmlFor="password">Password</label>
                <input
                className="border border-gray-300 shadow px-5 py-2 block"
                onChange={formik.handleChange}
                type='password'
                ...
                <label className="text-sm font-bold block mt-5" htmlFor="repassword">Password again</label>
                <input
                className="border border-gray-300 shadow px-5 py-2 block"
                onChange={formik.handleChange}
                type='password'
